...
//Checkin
exports.apiPutLocation = router.put("/location/:id", authenticateToken, apiPutLocation)
//Get time line
exports.apiGetTimeLine = router.get("/timeline/:id", authenticateToken, apiGetTimeLine)
