...
router.get("/admin/userInfo", checkAuthenticated, (req, res, next) => {
    ...
    // }else{
    //     return res.redirect("/admin/userInfo?page=1")
    // }
})
